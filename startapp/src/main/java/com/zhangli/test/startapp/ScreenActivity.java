package com.zhangli.test.startapp;
...
import com.zhangli.test.startapp.utils.SharedPreUtils;
import com.zhangli.test.startapp.utils.VersionUtils;
...
//                    Toast.makeText(ScreenActivity.this,"hander",Toast.LENGTH_LONG).show();
                    ...
                    break;
                case 2:
                    startActivity(new Intent(ScreenActivity.this,IndexActivity.class));
                    finish();
                    break;
            }
            return false;
